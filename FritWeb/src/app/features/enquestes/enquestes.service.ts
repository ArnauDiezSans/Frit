...
export interface EncuestaPregunta { encuestaPreguntaId: number; tipo: PreguntaTipo; texto: string; ayuda?: string; obligatoria: boolean; orden: number; minimo?: number; maximo?: number; condicionPreguntaOrden?: number | null; condicionOpcionOrden?: number | null; permiteAgregarOpciones: boolean; opciones: EncuestaOpcion[]; }
export interface EncuestaResumen { encuestaId: number; titulo: string; descripcion?: string; estado: EncuestaEstado; esVotacion: boolean; esAnonima: boolean; fechaCierre?: string; createdAt: string; creadorNombre: string; haRespondido: boolean; esDestinatario: boolean; respuestas: number; destinatarios: number; puedeGestionar: boolean; puedeEditarPublicada: boolean; }
export interface RespuestaValor { encuestaPreguntaId: number; texto?: string | null; numero?: number | null; opcionIds: number[]; nuevasOpciones?: string[]; }
...
export interface PreguntaWrite { tipo: PreguntaTipo; texto: string; ayuda?: string; obligatoria: boolean; minimo?: number; maximo?: number; condicionPreguntaOrden?: number | null; condicionOpcionOrden?: number | null; permiteAgregarOpciones: boolean; opciones: string[]; }
export interface EncuestaWrite { esVotacion: boolean; titulo: string; descripcion?: string; esAnonima: boolean; permiteEditarRespuesta: boolean; visibilidadResultados: VisibilidadResultados; fechaCierre?: string | null; destinatarioIds: number[]; preguntas: PreguntaWrite[]; }
