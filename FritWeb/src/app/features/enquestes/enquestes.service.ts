...
export interface EncuestaResumen { encuestaId: number; titulo: string; descripcion?: string; estado: EncuestaEstado; esVotacion: boolean; esAnonima: boolean; fechaCierre?: string; createdAt: string; creadorNombre: string; haRespondido: boolean; esDestinatario: boolean; respuestas: number; destinatarios: number; puedeGestionar: boolean; }
