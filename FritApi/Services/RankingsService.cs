...
public class RankingsService
{
            ...
            foreach (var jugador in partida.Jugadores)
            {
                ...
                foreach (var usuarioDetectado in jugadoresDetectados.Values)
                {
                    result.Add(new RankingPlayerRow(
                        ...
                        partida.Juego.Tipo,
                        partida.Juego.EsCooperativo,
                        partida.Juego.EsPorEquipos,
                        partida.Juego.EsNoLista,
                        partida.Fecha,
    ...
    private static List<RankingPartidaDto> BuildPartidas(List<Models.Partida> partidas)
    {
        return partidas
            .Select(partida => new RankingPartidaDto
            {
                ...
                JuegoEsCooperativo = partida.Juego.EsCooperativo,
                JuegoEsPorEquipos = partida.Juego.EsPorEquipos,
                JuegoEsNoLista = partida.Juego.EsNoLista,
                Fecha = partida.Fecha,
    ...
    private static List<RankingJugadorDto> BuildJugadores(IEnumerable<RankingPlayerRow> jugadores)
    {
        return jugadores
            .Select(jugador => new RankingJugadorDto
            {
                ...
                JuegoEsCooperativo = jugador.JuegoEsCooperativo,
                JuegoEsPorEquipos = jugador.JuegoEsPorEquipos,
                JuegoEsNoLista = jugador.JuegoEsNoLista,
                Fecha = jugador.Fecha,
    ...
    private sealed record RankingPlayerRow(
        ...
        string JuegoNombre,
        string JuegoTipo,
        bool JuegoEsCooperativo,
        bool JuegoEsPorEquipos,
        bool JuegoEsNoLista,
        DateOnly Fecha,
        int? DuracionMinutos,
        int NumeroJugadores,
