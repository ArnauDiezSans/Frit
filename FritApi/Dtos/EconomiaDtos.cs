...
public record EconomiaQuotaDto(string Persona, int Any, int Mes, decimal Import, int? MovimentId = null);
public record EconomiaMovimentDto(int Id, DateOnly Data, DateOnly DataValor, string DescriptorOriginal, string Descriptor, decimal Import, decimal? Saldo, string Categoria, bool RequereixRevisio, decimal ImportImputat, bool TeAssignacionsManuals);
